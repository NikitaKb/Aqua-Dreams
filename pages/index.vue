...
useHead({
  title: 'AD - Бассейны и термо | Строительство бассейнов в Ростове-на-Дону',
  meta: [
    { name: 'description', content: 'Строительство бассейнов и термо в Ростове-на-Дону. Профессиональное проектирование и монтаж бассейнов любой сложности. Бесплатная консультация и выезд специалиста.' },
    { name: 'keywords', content: 'бассейны, строительство бассейнов, термо, сауны, бани, хамамы, Ростов-на-Дону, проектирование бассейнов' },
